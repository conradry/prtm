...
from utils.training import (inference_epoch, loss_function, test_epoch,
                            train_epoch)
from utils.utils import (ExponentialMovingAverage, get_model,
                         get_optimizer_and_scheduler, save_yaml_file)
...
def main_function():
    ...
    optimizer, scheduler = get_optimizer_and_scheduler(
        args,
        model,
        scheduler_mode=args.inference_earlystop_goal
        if args.val_inference_freq is not None
        else "min",
    )
