...
def main(args):
    ...
    from protein_mpnn_utils import (ProteinMPNN, StructureDataset,
                                    StructureDatasetPDB, _S_to_seq, _scores,
                                    cat_neighbors_nodes, gather_edges,
                                    gather_nodes, gather_nodes_t, loss_nll,
                                    loss_smoothed, parse_fasta, parse_PDB,
                                    tied_featurize)
