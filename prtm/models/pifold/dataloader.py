...
from prtm.models.pifold.cath_dataset import CATH
from prtm.models.pifold.dataloader_gtrans import DataLoader_GTrans
from prtm.models.pifold.featurizer import featurize_GTrans
from prtm.models.pifold.ts_dataset import TS
...
def load_data(data_name, method, batch_size, data_root, num_workers=8, **kwargs):
    ...
    train_loader = DataLoader_GTrans(
        train_set,
    ...
    valid_loader = DataLoader_GTrans(
        valid_set,
        batch_size=batch_size,
        shuffle=False,
        num_workers=num_workers,
