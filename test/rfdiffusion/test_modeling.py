...
def test_motif_scaffolding_design():
    ...
    reference_structure = protein.from_pdb_string(
        reference_pdb_str, atom14_format=True, parse_hetatom=True
    )
...
def test_motif_scaffolding_with_target_design():
    gt_pdb_file = Path(__file__).parents[0] / f"reference_motif_scaffolding_w_target.pdb"
    with open(gt_pdb_file, "r") as f:
        gt_pdb_str = f.read()
...
def test_partial_diffusion_without_sequence_design():
    gt_pdb_file = Path(__file__).parents[0] / f"reference_partial_diffusion_wo_sequence.pdb"
    with open(gt_pdb_file, "r") as f:
        gt_pdb_str = f.read()
...
def test_partial_diffusion_with_sequence_design():
    gt_pdb_file = Path(__file__).parents[0] / f"reference_partial_diffusion_w_sequence.pdb"
    with open(gt_pdb_file, "r") as f:
        gt_pdb_str = f.read()
...
def test_partial_diffusion_with_multisequence_design():
    gt_pdb_file = Path(__file__).parents[0] / f"reference_partial_diffusion_w_multisequence.pdb"
    with open(gt_pdb_file, "r") as f:
        gt_pdb_str = f.read()
...
def test_scaffoldguided_tim_barrel_design():
    ...
    scaffold_structure = protein.from_pdb_string(
        scaffold_pdb_str, atom14_format=True, parse_hetatom=True
    )
...
def test_scaffoldguided_ppi_design():
    ...
    target_structure = protein.from_pdb_string(
        target_pdb_str, atom14_format=True, parse_hetatom=True
    )
