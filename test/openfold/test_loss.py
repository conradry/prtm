...
def test_run_torsion_angle_loss():
...
@skip_unless_alphafold_installed()
def test_between_residue_bond_loss_compare():
...
@skip_unless_alphafold_installed()
def test_between_residue_clash_loss_compare():
...
@skip_unless_alphafold_installed()
def test_compute_plddt_compare():
    n_res = consts.n_res
...
def test_find_structural_violations():
    n = consts.n_res
...
@skip_unless_alphafold_installed()
def test_find_structural_violations_compare():
...
@skip_unless_alphafold_installed()
def test_compute_renamed_ground_truth_compare():
...
@skip_unless_alphafold_installed()
def test_distogram_loss_compare():
    config = get_alphafold_config()
...
@skip_unless_alphafold_installed()
def test_experimentally_resolved_loss_compare():
    config = get_alphafold_config()
...
@skip_unless_alphafold_installed()
def test_supervised_chi_loss_compare():
    config = get_alphafold_config()
...
@skip_unless_alphafold_installed()
def test_violation_loss_compare():
    config = get_alphafold_config()
...
@skip_unless_alphafold_installed()
def test_backbone_loss_compare():
    config = get_alphafold_config()
...
@skip_unless_alphafold_installed()
def test_sidechain_loss_compare():
    config = get_alphafold_config()
    c_sm = config.model.heads.structure_module
