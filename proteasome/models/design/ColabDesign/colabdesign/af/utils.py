...
from colabdesign.shared.protein import _np_kabsch, renum_pdb_str
from colabdesign.shared.utils import Key, update_dict
...
class _af_utils:
    ...
    def set_args(self, **kwargs):
        ...
        if "recycle_mode" in kwargs:
            ...
            if (
                kwargs["recycle_mode"] in ok_recycle_mode_swap
        ...
        if "optimizer" in kwargs:
            self.set_optimizer(
                kwargs.pop("optimizer"), learning_rate=kwargs.pop("learning_rate", None)
            )
    ...
    # -------------------------------------
    def animate(
        self, s=0, e=None, dpi=100, get_best=True, traj=None, aux=None, color_by="plddt"
    ):
        """
