...
from alphafold.data import (pipeline, pipeline_multimer, pipeline_uniprot,
                            templates)
...
def main(argv):
    ...
    _check_flag(
        "pdb70_database_path",
        "feature_mode",
        should_be_set=not (run_multimer_system or "fullpdb" in FLAGS.feature_mode),
    )
    _check_flag(
        "pdb_seqres_database_path",
        "feature_mode",
        should_be_set=(run_multimer_system or "fullpdb" in FLAGS.feature_mode),
    )
    _check_flag(
        "uniprot_database_path",
        "feature_mode",
